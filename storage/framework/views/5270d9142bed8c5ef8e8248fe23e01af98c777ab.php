                  ...
                  <ul class="checkbox_list">
                    <li>
                      <input name="json_access[menu_id][]" type="checkbox" value="<?php echo e($row->id); ?>"  onchange="checkAllRole(<?php echo e($row->id); ?>)"
                        id="json_access_menu_id_<?php echo e($row->id); ?>" class="mr-15">
                    ...
                    <li>
                      <input name="json_access[menu_id][]" type="checkbox" value="<?php echo e($sub->id); ?>" onchange="checkAllRole(<?php echo e($sub->id); ?>)"
                        id="json_access_menu_id_<?php echo e($sub->id); ?>" class="mr-15">
            ...
            <div class="tab-pane" id="tab_3">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <ul class="checkbox_list">
                    <li>
                      <label for="json_access_module_code_<?php echo e($row->id); ?>"><strong><?php echo e($row->name); ?></strong></label>
                    </li>
                    ...
                    <li>
                      <input name="json_access[function_code][]" type="checkbox" value="<?php echo e($sub->function_code); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/admin/pages/roles/create.blade.php ENDPATH**/ ?>