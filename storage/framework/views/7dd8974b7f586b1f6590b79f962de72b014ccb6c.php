                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <label><?php echo app('translator')->get('Chuyên khoa'); ?> <small class="text-red">*</small></label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtTitle" onchange="getUrlPart('txtTitle','txtUrlPart')" onclick="getUrlPart('txtTitle','txtUrlPart')" onblur="getUrlPart('txtTitle','txtUrlPart')" name="title" placeholder="<?php echo app('translator')->get('Title'); ?>" value="<?php echo e(old('title')); ?>" required>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/admin/pages/cms_profile/create.blade.php ENDPATH**/ ?>