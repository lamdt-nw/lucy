                                ...
                                <li class="dd-item" data-id="<?php echo e($item->id); ?>">
                                  <div class="dd-handle ">
                                    ...
                                    <span class="dd-nodrag pull-right">
                                      <small>(<?php echo e(App\Consts::STATUS[$item->status]); ?>)</small>
                    ...
                    <form action="<?php echo e(route(Request::segment(2) . '.store')); ?>" method="POST" class="form-horizontal"
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="link-url_link" placeholder="<?php echo app('translator')->get('Url'); ?>"
                              ...
                              <select id="category_link" class="form-control select2" onchange="getUrl()" autocomplete="off">
                                <option value="" selected>-Chọn danh mục-</option>
                                <?php $__currentLoopData = $category_title; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="/<?php echo e($category->taxonomy.'/'.$category->url_part); ?>.html" ><?php echo e($category->title .' ('.App\Consts::TAXONOMY[$category->taxonomy].')'); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="link-icon" placeholder="VD: fa fa-folder"
                              name="json_params[icon]" autocomplete="off">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <div class="form-control">
                              <?php $__currentLoopData = App\Consts::STATUS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label>
                                  <input type="radio" name="status" value="<?php echo e($key); ?>"
                                    <?php echo e($item->status == $key ? 'checked' : ''); ?>>
                                  <small class="mr-15"><?php echo e(__($value)); ?></small>
                                </label>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php $__env->startSection('script'); ?>
  ...
  <script type="text/javascript">
    ...
    function getUrl() {
      ...
      var url_c = $('#category_link').val();
      $('#link-url_link').val(url_c);
    ...
    $('.edit_menu').click(function() {
      ...
      if (!$.isEmptyObject(item)) {
        ...
        if (item.json_params) {
          ...
          _form.find('#link-icon').val(item.json_params.icon || '');
        }
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntdconyj0yk6/phongkham.nvoting.com/resources/views/admin/pages/menus/edit.blade.php ENDPATH**/ ?>