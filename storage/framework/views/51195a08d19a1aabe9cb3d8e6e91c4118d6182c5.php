	            ...
	            <div class="entry-loop">
	               <ul class="d_flex">
						...
						?>
		                  <li class="d_flex">
		                     <div class="thumb">
		                     	<a href="/chi-tiet-dich-vu/<?php echo e($item->url_part); ?>.html" title="<?php echo e($item->title); ?>">
		                     		<img data-lazyloaded="1" width="480" height="270" src="<?php echo e($image); ?>" onerror="this.src='/public/themes/frontend/phongkham/img/macdinh_tinbai_360_200.png'" class="attachment-thumb-480x270 size-thumb-480x270 wp-post-image entered litespeed-loaded" alt="<?php echo e($item->title); ?>" decoding="async" data-ll-status="loaded">
		                     	</a>
		                     </div>
		                     <div class="text">
	         	...
	         	<div class="widget_question">
				   ...
				   <div class="widget__container">
				      <ul>
				        ...
				        <li>
				        	<h3><a href="/dich-vu/<?php echo e($dv->url_part); ?>.html" title="<?php echo e($dv->title); ?>"><?php echo e($dv->title); ?></a></h3>
				        </li>
				        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				      </ul>
				   </div>
...
<?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/frontend/pages/post/default_dichvu.blade.php ENDPATH**/ ?>