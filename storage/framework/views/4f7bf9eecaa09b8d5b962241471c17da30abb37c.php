                          ...
                          data-id="2374062" data-element_type="widget" data-widget_type="pxl_icon.default">
                            <div class="elementor-widget-container">
                              <div class="pxl-icon-list pxl-icon1 style-default " data-wow-delay="ms">
								...
								<a class="elementor-repeater-item-923dd4c ps-top" <?php if($locale == $language->lang_code) echo 'style="color: #DF0A0A;"' ?> href="/language?lang=<?php echo e($language->lang_code); ?>">
                                  <?=$language->title?>
                                </a>
								<?php } ?>
                              </div>
                            ...
                            <div class="elementor-widget-container">
                              ...
                              <?php echo csrf_field(); ?>
                                <div class="searchform-wrap">
                                  <input type="text" placeholder="<?php echo e($array_translate[strtolower('Search')]->$locale); ?>..." name="keyword" class="search-field">
...
<?php /**PATH /home/vb2kcoqr09ph/chovay.nvoting.com/resources/views/frontend/element/header.blade.php ENDPATH**/ ?>