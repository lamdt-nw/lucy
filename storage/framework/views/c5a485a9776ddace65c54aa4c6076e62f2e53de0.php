                          ...
                          <div class="elementor-container elementor-column-gap-extended ">
                            ...
                            data-id="af3cd5c" data-element_type="column">
                              <div class="elementor-widget-wrap elementor-element-populated">
                                    ...
                                    <div id="pxl-pxl_heading-c383065-5492" class="pxl-heading px-sub-title-under-style">
                                      <div class="pxl-heading--inner">
                                        <h3 class="pxl-item--title " data-wow-delay="ms">
                                          <?php echo e($array_translate[strtolower('DropUsALine')]->$locale); ?>

                                        </h3>
                                        <div class="pxl-item--subtitle px-sub-title-under " data-wow-delay="ms">
                                          <span class="pxl-item--subtext">
                                            <?php echo e($array_translate[strtolower('ContentContact')]->$locale); ?>
                                ...
                                data-id="6e3e640" data-element_type="widget">
                                  <div class="elementor-widget-container">
                                          ...
                                          <div class="pxl--item">
                                            <p>
                                              <span class="wpcf7-form-control-wrap" data-name="your-message">
                                                ...
                                                aria-required="true" aria-invalid="false" placeholder="Text*" name="content">
                                                </textarea>
                                              </span>
                                            </p>
                                          </div>
                                          <div class="pxl--item pxl-text-center">
                                            <p>
                                              <button type="submit" class="wpcf7-submit btn btn-skew">
                                                <span>
                                                  <?php echo e($array_translate[strtolower('ContactUs')]->$locale); ?>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vb2kcoqr09ph/chovay.nvoting.com/resources/views/frontend/pages/contact/index.blade.php ENDPATH**/ ?>