	      ...
	      <div class="d_flex">
	         ...
	         <div id="primary" class="sec32_col1">
	            ...
	            <div class="entry-loop">
	               <ul class="d_flex">
	               		<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>												<?php							$image = $item->image != '' ? $item->image : '/public/themes/frontend/phongkham/img/macdinh_tinbai_360_200.png';						?>
		                  <li class="d_flex">
		                     <div class="thumb">
...
<?php /**PATH /home/ntdconyj0yk6/phongkham.nvoting.com/resources/views/frontend/pages/post/default_dichvu.blade.php ENDPATH**/ ?>