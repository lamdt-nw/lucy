	            		...
	            		<li class="d_flex">
	            			<div class="thumb">
	            				<a href="/chi-tiet-thu-vien/<?php echo e($item->url_part); ?>.html" title="<?php echo e($item->title); ?>">
	            					<img data-lazyloaded="1" src="<?php echo e($image); ?>" onerror="this.src='/public/themes/frontend/phongkham/img/macdinh_tinbai_360_200.png'" width="480" height="270" data-src="<?php echo e($image); ?>" class="attachment-thumb-480x270 size-thumb-480x270 wp-post-image entered litespeed-loaded" alt="<?php echo e($item->title); ?>" decoding="async" data-ll-status="loaded">
	            				</a>
	            			</div>
	            			<div class="text">
...
<?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/frontend/pages/post/category_thuvien.blade.php ENDPATH**/ ?>