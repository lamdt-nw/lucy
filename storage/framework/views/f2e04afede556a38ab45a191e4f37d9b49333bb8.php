      ...
      <form action="<?php echo e(route(Request::segment(2) . '.index')); ?>" method="GET">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="form-group">
                <label><?php echo app('translator')->get('Danh mục dịch vụ'); ?></label>
                  ...
                  <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($item->parent_id == 0 || $item->parent_id == null): ?>
                      <option value="<?php echo e($item->id); ?>"
                        <?php echo e(isset($params['department_id']) && $params['department_id'] == $item->id ? 'selected' : ''); ?>>
                      ...
                      <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($item->id == $sub->parent_id): ?>
                          <option value="<?php echo e($sub->id); ?>"
                            <?php echo e(isset($params['department_id']) && $params['department_id'] == $sub->id ? 'selected' : ''); ?>>
                            - -
                          ...
                          <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($sub->id == $sub_child->parent_id): ?>
                              <option value="<?php echo e($sub_child->id); ?>"
                                <?php echo e(isset($params['department_id']) && $params['department_id'] == $sub_child->id ? 'selected' : ''); ?>>
                                - - - -
          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                ...
                <th><?php echo app('translator')->get('Triệu trứng'); ?></th>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntdconyj0yk6/phongkham.nvoting.com/resources/views/admin/pages/contacts/index.blade.php ENDPATH**/ ?>