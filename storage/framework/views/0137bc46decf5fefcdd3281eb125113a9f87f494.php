                  ...
                  <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    <div class="form-group">
                      <div class="form-group">
                        ...
                        <textarea name="content" class="form-control" id="content_vi"><?php echo e($detail->content); ?></textarea>
                      </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/admin/pages/cms_posts_dichvu/edit.blade.php ENDPATH**/ ?>