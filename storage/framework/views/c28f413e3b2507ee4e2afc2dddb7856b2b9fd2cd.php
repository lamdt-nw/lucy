                            ...
                            <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($item->id == $sub->parent_id): ?>
                                <option value="<?php echo e($sub->id); ?>"
                                  <?php echo e(old('taxonomy_id') == $sub->id ? 'selected' : ''); ?>>- - <?php echo e($sub->title->vi); ?>
          ...
          <div class="modal-body">
            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody id="dataTablePost">
                ...
                <tr>
                  <td><?php echo e($post->title->vi); ?></td>
                  <td>
                    ...
                    <input type="hidden" id="post_title_<?php echo e($post->id); ?>" value="<?php echo e($post->title->vi); ?>" />
                  </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\duhoc\resources\views/admin/pages/cms_posts/create.blade.php ENDPATH**/ ?>