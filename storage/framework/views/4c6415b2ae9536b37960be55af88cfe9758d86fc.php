...
foreach ($parents as $item){
  $array_category[$item->id] = $item->title->$locale;
}
                  ...
                  ?>
                    <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                      ...
                      <tr class="valign-middle <?php echo e($class_e); ?>">
                        ...
                        <td>
                          <a href="<?php echo e(route(Request::segment(2) . '.edit', $row->id)); ?>" style="font-size: 14px;"><?php echo e($row->title->$locale); ?></a>
                        </td>
                        <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\lucy\resources\views/admin/pages/cms_posts_dichvu/index.blade.php ENDPATH**/ ?>