...
<?php if(isset($hot_news)): ?>
    <?php if(count($hot_news) > 0): ?>
                            ...
                            <div class="home17__row2 d_flex">
                                ...
                                <div class="home17__row2__col home17__row2__col--v1 query_loop_ul_v2">
                                    <ul class="d_flex ">
                                        <li class="d_flex">
                                            <div class="thumb">
                                                <a href="/chi-tiet/<?php echo e($items[0]->url_part); ?>.html" title="<?php echo e($items[0]->title); ?>"><img onerror="this.src='/public/themes/frontend/phongkham/img/macdinh_tinbai_360_200.png'" data-lazyloaded="1" 
                                ...
                                <div class="home17__row2__col home17__row2__col--v2 query_loop_ul_v2">
                                    <ul class="d_flex ">
                                        ...
                                        <li class="d_flex">
                                            <div class="thumb">
                                                <a href="/chi-tiet/<?php echo e($item->url_part); ?>.html" title="<?php echo e($item->title); ?>"><img onerror="this.src='/public/themes/frontend/phongkham/img/macdinh_tinbai_360_200.png'" data-lazyloaded="1"
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
<?php endif; ?> <?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/frontend/element/tinnoibat.blade.php ENDPATH**/ ?>