<?php
  ...
  $listdv = App\Http\Services\ContentService::getCmsDichvu($params)->get();
?>
<?php if(isset($dichvu)): ?>
                                ...
                                <div class="item">
                                    <div class="item__img">
                                        <a href="/dich-vu/<?php echo e($item->url_part); ?>.html">
                                            <img onerror="this.src='/public/themes/frontend/phongkham/img/macdinh_tinbai_360_200.png'" data-lazyloaded="1" src="<?php echo e($item->json_params->image); ?>"
    ...
    <?php endif; ?>
<?php endif; ?>     
<?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/frontend/element/dichvu.blade.php ENDPATH**/ ?>