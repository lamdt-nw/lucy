              ...
              <div class="tab-pane active" id="tab_1">
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title[<?php echo e($lang->lang_code); ?>]" id="<?php echo e($id); ?>" <?php echo e($onchange); ?> <?php echo e($onclick); ?> <?php echo e($onblur); ?> placeholder="<?php echo app('translator')->get('Title'); ?> <?php echo e($lang->title); ?>" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                      <div class="form-group">
                        ...
                        <textarea name="content[<?php echo e($lang->lang_code); ?>]" class="form-control" id="content_<?php echo e($lang->lang_code); ?>"><?php echo e(old('content')); ?></textarea>
                      </div>
                    </div>
                  </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="form-group">
					...
					<div class="form-control">
						...
						<input type="checkbox" id="hienthi_1" name="hienthi[]" value="1">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\lucy\resources\views/admin/pages/cms_taxonomys/create.blade.php ENDPATH**/ ?>