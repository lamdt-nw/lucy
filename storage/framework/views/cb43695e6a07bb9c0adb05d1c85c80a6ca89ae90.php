...
data-elementor-post-type="page">
          ...
          data-id="5b8b1e76" data-element_type="widget" data-widget_type="heading.default">
            <div class="elementor-widget-container">
              <h1 class="elementor-heading-title elementor-size-default">
                <?php echo e($array_translate[strtolower('About Us')]->$locale); ?>
        ...
        <div class="e-con-inner">
          ...
          data-id="89b1754" data-element_type="container" data-settings="{&quot;content_width&quot;:&quot;full&quot;}">
            ...
            data-id="aa2bf81" data-element_type="widget" data-widget_type="image.default">
              <div class="elementor-widget-container">
                <img decoding="async" width="600" height="400" src="<?php echo e($item->image); ?>"
                class="attachment-full size-full wp-image-2469" alt="" srcset="<?php echo e($item->image); ?>"
        ...
        data-widget_type="gallery.default">
          <div class="elementor-widget-container">
            ...
            <div class="elementor-gallery__container">
              ...
              ?>
              <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_img => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="e-gallery-item elementor-gallery-item elementor-animated-content"
                href="<?php echo e($image); ?>"
                data-elementor-open-lightbox="yes" data-elementor-lightbox-slideshow="6e2b3b2"
                data-elementor-lightbox-title="<?php echo e($item->title->$locale); ?>"
                data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjQ3NiwidXJsIjoiaHR0cHM6XC9cL2x1Y3liZWF1dHkuY2FcL3dwLWNvbnRlbnRcL3VwbG9hZHNcLzIwMjNcLzA4XC8wREEwQkJFNC05MkYyLTREREEtQUMyOC00MERFMUQzMEU1RkQtMjQ1NDktMDAwMDE3OThGRUFCNzZEOS5qcGciLCJzbGlkZXNob3ciOiI2ZTJiM2IyIn0%3D">
                  <div class="e-gallery-image elementor-gallery-item__image" data-thumbnail="<?php echo e($image); ?>"
        ...
        data-widget_type="button.default">
          <div class="elementor-widget-container">
            <div class="elementor-button-wrapper">
              <a class="elementor-button elementor-button-link elementor-size-sm" href="<?php echo e($web_information->social->instagram ?? ''); ?>" target="_blank">
  ...
  <?php echo $__env->make('frontend.element.why_diffirent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\lucy\resources\views/frontend/pages/post/intro.blade.php ENDPATH**/ ?>