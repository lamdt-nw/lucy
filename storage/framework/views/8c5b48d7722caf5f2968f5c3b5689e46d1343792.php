                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txtUrlPart_<?php echo e($locale); ?>" onchange="getUrlPart('txtUrlPart_<?php echo e($locale); ?>','txtUrlPart_<?php echo e($locale); ?>')" onclick="getUrlPart('txtUrlPart_<?php echo e($locale); ?>','txtUrlPart_vi')" onblur="getUrlPart('txtUrlPart_<?php echo e($locale); ?>','txtUrlPart_<?php echo e($locale); ?>')" name="url_part" placeholder="<?php echo app('translator')->get('Alias'); ?>"
          ...
          <div class="modal-body">
            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody id="dataTablePost">
                ...
                <tr>
                  <td><?php echo e($post->title->$locale); ?></td>
                  <td>
                    ...
                    <input type="hidden" id="post_title_<?php echo e($post->id); ?>" value="<?php echo e($post->title->$locale); ?>" />
                  </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\lucy\resources\views/admin/pages/cms_posts/create.blade.php ENDPATH**/ ?>