<?php
  ...
  $params['limit'] = '10';
  $items_new = App\Http\Services\ContentService::getCmsPostDichvu($params)
  ->get();
?>
<?php if(isset($last_news)): ?>
    <?php if(count($last_news) > 0): ?>
                                ...
                                <div class="owl_ul owl-carousel owl-theme owl__v1">
                                    <?php if(count($items_new) > 0): ?>
                                        ...
                                        <div class="owl_ul_li item">
                                            <article>
                                                <div class="thumb">
                                                    <a href="/chi-tiet-dich-vu/<?php echo e($item->url_part); ?>.html" title="<?php echo e($item->title); ?>"><img onerror="this.src='/public/themes/frontend/phongkham/img/macdinh_tinbai_360_200.png'" data-lazyloaded="1"
                                                ...
                                                <div class="text">
                                                    <h3 class="text__title"><a href="/chi-tiet-dich-vu/<?php echo e($item->url_part); ?>.html"><?php echo e($item->title); ?></a></h3>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
<?php endif; ?> <?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/frontend/element/tintucmoinhat.blade.php ENDPATH**/ ?>