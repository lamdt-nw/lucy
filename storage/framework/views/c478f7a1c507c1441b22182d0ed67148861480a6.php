...
<body class="post-template-default single single-post single-format-standard cbp-spmenu-push cbp-spmenu-widget-push">	<?php echo $__env->make('frontend.panels.scriptfb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	   ...
	   <div class="wrap">
	      <div class="d_flex">
	         ...
	         <div id="primary" class="sec32_col1">
	         	<div class="entry-doctor d_flex">
				   ...
				   <div class="text">
				      ...
				      <div class="text__phone d_flex">
				         ...
				         <?php endif; ?>
				         <?php if($detail->sdt): ?>
				         	<div class="text__phone__2"><a href="tel:<?php echo e($detail->sdt); ?>"><small>Liên hệ:</small> <br class="d_mb"> <small><?php echo e($detail->sdt); ?></small></a></div>
				         <?php endif; ?>
				      </div>
				   </div>
				</div>
	            ...
	            <div class="fb-comments" data-href="<?php echo e(url()->full()); ?>" data-width="100%" data-numposts="5"></div>
...
<?php /**PATH /home/ntdconyj0yk6/phongkham.nvoting.com/resources/views/frontend/pages/post/detail_doctor.blade.php ENDPATH**/ ?>