      ...
      <form role="form" action="<?php echo e(route(Request::segment(2) . '.update', $adminMenu->id)); ?>" method="POST">
        ...
        <div class="box-body">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label><?php echo app('translator')->get('Hiển thị menu ngang'); ?></label>
              <div class="form-control">
                <label>
                  <input type="radio" name="is_check" value="active"
                    <?php echo e($adminMenu->is_check == 'active' ? 'checked' : ''); ?>>
                  <small><?php echo app('translator')->get('yes'); ?></small>
                </label>
                <label>
                  <input type="radio" name="is_check" value="deactive" class="ml-15"
                    <?php echo e($adminMenu->is_check == 'deactive' ? 'checked' : ''); ?>>
                  <small><?php echo app('translator')->get('no'); ?></small>
                </label>
              </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/admin/pages/admin_menus/edit.blade.php ENDPATH**/ ?>