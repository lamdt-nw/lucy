                ...
                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                      ...
                      <tr class="valign-middle">
                        <td><img style="height:150px;object-fit: cover;" src="<?php echo e($row->image ?? $row->image ?? '\public\themes\frontend\yenbinh\themes\chuyennt\images\pngwing.com.png'); ?>"></td>
                        <td>
                          <strong style="font-size: 14px;"><?php echo e($row->title); ?></strong>
                        </td>
                        <td>
                          <?php echo e($row->chucvu); ?>
                        ...
                        <td>
                          <?php $__currentLoopData = $taxonomys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxonomy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($taxonomy->id == $row->taxonomy): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntdconyj0yk6/phongkham.nvoting.com/resources/views/admin/pages/cms_profile/index.blade.php ENDPATH**/ ?>