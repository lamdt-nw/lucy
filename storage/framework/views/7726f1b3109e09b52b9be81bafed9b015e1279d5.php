          ...
          <div class="col-md-6">
			...
			<div class="form-group">
			  ...
			  <div id="image-holder" style="margin-top:15px;max-height:100px;">
				<?php if(old('image') != ''): ?>
				<img id="view_avatar" style="height: 5rem;" src="<?php echo e(old('image')); ?>">
				<?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vb2kcoqr09ph/chovay.nvoting.com/resources/views/admin/pages/cms_language/create.blade.php ENDPATH**/ ?>