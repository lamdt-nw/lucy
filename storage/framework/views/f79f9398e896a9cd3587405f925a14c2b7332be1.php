		            		...
		            		<li class="d_flex">
		            			<div class="thumb">
		            				<a href="/dich-vu/<?php echo e($item->url_part); ?>.html">
		            					<img data-lazyloaded="1" src="<?php echo e($image); ?>" onerror="this.src='/public/themes/frontend/phongkham/img/macdinh_tinbai_360_200.png'" width="400" height="480" data-src="<?php echo e($image); ?>" alt="<?php echo e($item->title); ?>" data-ll-status="loaded" class="entered litespeed-loaded">
		            				</a>
		            			</div>
		            			<div class="text">
...
<?php /**PATH /home/ntdconyj0yk6/dichvu.spmph.edu.vn/resources/views/frontend/pages/post/category_dichvu.blade.php ENDPATH**/ ?>