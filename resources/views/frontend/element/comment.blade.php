  ...
  <div class="elementor-container elementor-column-gap-default">
    ...
    data-id="98dfd0" data-element_type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;animation&quot;:&quot;fadeIn&quot;,&quot;animation_delay&quot;:500}">
      <div class="elementor-widget-wrap elementor-element-populated">
        @foreach($blocksContent as $comment)
          @if($comment->block_code == 'comment' and $comment->parent_id == '')
        ...
        data-id="47cc1cb9" data-element_type="section">
          <div class="elementor-container elementor-column-gap-default owl-carousel elementor-inner-section-carousel">
            @foreach($blocksContent as $comment_child)
              @if($comment_child->block_code == 'comment' and $comment_child->parent_id != '')
                            ...
                            <div class="elementor-testimonial-meta-inner">
                              <div class="elementor-testimonial-details">
                                <div class="elementor-testimonial-content">
                                  ...
                                  <img src="{{ $comment_child->image }}" alt="Avatar" class="avatar-img">
                                </div>
                                  <div class="elementor-testimonial-name">
                                    {{ $comment_child->title->$locale }}<br/>
                                    <p class="elementor-testimonial-time">{{ date('Y-m-d', strtotime($comment_child->created_at)) }}</p>
                                  </div>
                                </div>
                              </div>
                            </div>
