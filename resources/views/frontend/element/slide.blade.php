                ...
                <div class="elementor-slides-wrapper elementor-main-swiper swiper" dir="ltr" data-animation="fadeInUp">
                    <div class="swiper-wrapper elementor-slides">
                        @foreach($blocksContent as $banner)
                            @if($banner->block_code == 'slide')
                                <style>
                                    .elementor-168 .elementor-element.elementor-element-bef0fb3 .elementor-repeater-item-{{ $banner->id }} .swiper-slide-bg {
                                        background-image: url({{ $banner->image_background }});
                                    }
                                </style>
                                <div class="elementor-repeater-item-{{ $banner->id }} swiper-slide">
                                    <div class="swiper-slide-bg" role="img"></div>
                                    <a class="swiper-slide-inner" href="{{ $banner->url_link }}">
                                        <div class="swiper-slide-contents">
                                            <div class="elementor-slide-heading">{{ $banner->title->$locale }}</div>
                                            <div class="elementor-slide-description">{{ $banner->brief->$locale }}</div>
                                            <div class="elementor-button elementor-slide-button elementor-size-sm">{{ $banner->url_link_title->$locale }}</div>
                                        </div>
                                    </a>
                                </div>
                            @endif
                ...
                <div class="elementor-slides-wrapper elementor-main-swiper swiper" dir="ltr" data-animation="fadeInUp">
                    <div class="swiper-wrapper elementor-slides">
                        @foreach($blocksContent as $banner)
                            @if($banner->block_code == 'slide')
                                <style>
                                    .elementor-168 .elementor-element.elementor-element-6d2f525 .elementor-repeater-item-{{ $banner->id }} .swiper-slide-bg{
