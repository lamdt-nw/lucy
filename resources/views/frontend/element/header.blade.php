...
<link rel='stylesheet' href={{ asset('themes/frontend/lucy/new_js/post-32.css?ver=1700767758')}} media='all' />
<style>
        ...
        <div class="elementor-widget-wrap elementor-element-populated">
          ...
          data-id="2374062" data-element_type="widget" data-widget_type="pxl_icon.default">
            <div class="elementor-widget-container">
              <div class="pxl-icon-list pxl-icon1 style-default " data-wow-delay="ms">
                <a class="elementor-repeater-item-923dd4c ps-top" href="{{ $web_information->social->facebook ?? '' }}" target="_blank">
                  <i aria-hidden="true" class="fab fa-facebook-f">
                  </i>
                </a>
                <a class="elementor-repeater-item-5f8be11 ps-top" href="{{ $web_information->social->instagram ?? '' }}" target="_blank">
                  <i aria-hidden="true" class="fab fa-instagram">
                  </i>
                </a>
                <a class="elementor-repeater-item-7e3ed51 ps-top" href="{{ $web_information->social->tiktok ?? '' }}" target="_blank">
          ...
          data-id="f0d597d" data-element_type="widget" data-widget_type="pxl_link.default">
            <div class="elementor-widget-container">
              ...
              data-wow-delay="ms">
                <li>
                  <a href="mailto:{{ $web_information->information->email ?? '' }}" class="">
          ...
          data-id="59bf831" data-element_type="widget" data-widget_type="pxl_link.default">
            <div class="elementor-widget-container">
              ...
              data-wow-delay="ms">
                <li>
                  <a href="tel:{{ $web_information->information->hotline ?? '' }}" class="">
        ...
        <div class="elementor-widget-wrap elementor-element-populated">
          ...
          data-id="1c7ea3e7" data-element_type="widget" data-widget_type="image.default">
            <div class="elementor-widget-container">
              ...
              <a href="/">
                <img width="800" height="473" src="{{ $web_information->image->logo_header ?? '' }}" alt="" srcset="{{ $web_information->image->logo_header ?? '' }}"
              ...
              data-layout="horizontal" data-last-item="cta">
                ...
                data-full-width="yes">
                  <ul id="menu-1-32e3a5d1" class="hfe-nav-menu">
                    ...
                    ?>
                        <li id="menu-item-{{ $taxonomy->id }}" class="menu-item menu-item-type-post_type menu-item-object-page parent hfe-creative-menu menu-item-has-children hfe-has-submenu">
                            <div class="hfe-has-submenu-container">
                                <a href="/{{ $taxonomy->taxonomy.'/'.$taxonomy->url_part.'.html' }}" class="hfe-menu-item">
                                    {{ $taxonomy->title->$locale }}
                            ...
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-1127" class="menu-item menu-item-type-post_type menu-item-object-page hfe-creative-menu">
                                    <a href="/{{ $sub_taxonomy->taxonomy.'/'.$sub_taxonomy->url_part.'.html' }}" class="hfe-sub-menu-item">
                                    {{ $sub_taxonomy->title->$locale }}
                                    </a>
                                </li>
                                <?php } } ?>
                            </ul>
                    ...
                    <?php }else{ ?>
                        ...
                        <li id="menu-item-{{ $taxonomy->id }}" class="menu-item menu-item-type-post_type menu-item-object-page parent hfe-creative-menu">
                          <a href="/{{ $taxonomy->taxonomy.'/'.$taxonomy->url_part.'.html' }}" class="hfe-menu-item">
                            {{ $taxonomy->title->$locale }}
                          </a>
                        </li>
                    ...
                    <?php } } } ?>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page parent hfe-creative-menu">
                          <a href="{{ $web_information->information->url_booking ?? '' }}" class="hfe-menu-item">
                            {{$array_translate[strtolower('Booking now')]->$locale }}
                          </a>
                        </li>
                  </ul>
                </nav>
