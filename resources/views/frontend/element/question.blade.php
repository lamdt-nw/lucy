...
<script src={{ asset("themes/frontend/lucy/new_js/scripts.min.js?ver=4.23.1")}}></script>
<link rel='stylesheet' href={{ asset('themes/frontend/lucy/new_js/style-static.min.css?ver=4.23.1')}} media='all' />
<link rel='stylesheet' href={{ asset('themes/frontend/lucy/new_js/et-core-unified-tb-226179-tb-224344-deferred-73.min.css?ver=1701704625')}} media='all' />
@foreach($blocksContent as $question)
  @if($question->block_code == 'question' and $question->parent_id == '')
  <style>
    div.et_pb_section.et_pb_section_5 {
        background-image: linear-gradient(180deg,rgba(0,0,0,0.58) 0%,rgba(0,0,0,0.41) 100%),url({{ $question->image_background }})!important;
    }
  </style>
    ...
    @endphp
        @foreach ($columns as $columnIndex => $column)
          <div class="et_pb_column et_pb_column_1_3 et_pb_column_16  et_pb_css_mix_blend_mode_passthrough">
            @foreach ($column as $question_list) 
                <div class="et_pb_module et_pb_toggle et_pb_toggle_0 et_pb_toggle_item  et_pb_toggle_close">
                  <h5 class="et_pb_toggle_title">
                    {{ $question_list['title'][$locale] }}
                  </h5>
                  <div class="et_pb_toggle_content clearfix">
                    <div class="vc_tta-panel-body">
                      <div class="wpb_text_column wpb_content_element ">
                        <div class="wpb_wrapper">
                          {!! $question_list['content'][$locale] !!}
                        </div>
                      </div>
                    </div>
                  </div>
