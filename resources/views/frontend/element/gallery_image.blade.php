  ...
  <div class="elementor-container elementor-column-gap-default">
    ...
    data-id="35a91b6d" data-element_type="column">
      <div class="elementor-widget-wrap elementor-element-populated">
        @foreach($blocksContent as $photo)
          @if($photo->block_code == 'photo' and $photo->parent_id == '')
            ...
            data-widget_type="gallery.default">
              <div class="elementor-widget-container">
                <div class="elementor-gallery__container">
                  @foreach($blocksContent as $photo_child)
                    @if($photo_child->block_code == 'photo' and $photo_child->parent_id != '')
                      <a class="e-gallery-item elementor-gallery-item elementor-animated-content"
                      href="{{ $photo_child->url_link }}" target="_blank">
                        <div class="e-gallery-image elementor-gallery-item__image" data-thumbnail="{{ $photo_child->image }}"
