@foreach($blocksContent as $booking)
  @if($booking->block_code == 'booking')
            ...
            data-id="63ba552f" data-element_type="widget" data-widget_type="button.default">
              <div class="elementor-widget-container">
                <div class="elementor-button-wrapper">
                  <a class="elementor-button elementor-button-link elementor-size-sm" href="{{ $booking->url_link }}">
                    <span class="elementor-button-content-wrapper">
                      <span class="elementor-button-text">
                        {{ $booking->url_link_title->$locale }}
                      </span>
                    </span>
                  </a>
                </div>
