                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title[{{ $lang->lang_code }}]" id="{{ $id }}" {{ $onchange }} {{ $onclick }} {{ $onblur }} placeholder="@lang('Title') {{ $lang->title }}" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                      <div class="form-group">
                        ...
                        <textarea name="content[{{ $lang->lang_code }}]" class="form-control" id="content_{{ $lang->lang_code }}">{{ old('content') }}</textarea>
                      </div>
                    </div>
                  </div>
                    @endforeach
                    ...
                    <div class="form-group">
						<div class="row">
							...
							<div class="col-md-12">
							  ...
							  <div class="input-group">
								<span class="input-group-btn">
								  <a data-input="image_background" onclick="openPopupImg('image_background')" data-preview="image_background-holder" class="btn btn-primary"
									data-type="cms-image">
									<i class="fa fa-picture-o"></i> @lang('choose')
								  </a>
								</span>
