                  ...
                  @endphp
                    <form action="{{ route(Request::segment(2) . '.destroy', $row->id) }}" method="POST"
                      ...
                      <tr class="valign-middle {{ $class_e }}">
                        ...
                        <td>
                          <a href="{{ route(Request::segment(2) . '.edit', $row->id) }}" style="font-size: 14px;">{{ $row->title->$locale }}</a>
                        </td>
                        <td>
                          {{ $row->fullname }}
                        </td>
                        ...
                        <td class="text-center">
                          <a class="btn btn-sm btn-warning" data-toggle="tooltip" title="@lang('Cập nhật tin bài')"
