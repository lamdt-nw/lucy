        ...
        <div class="box-body">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="lang_code" value="{{ $rows->lang_code }}" required>
            </div>
            <div class="form-group">
              <label>@lang('Tiêu đề ngôn ngữ') <small class="text-red">*</small></label>
              <input type="text" class="form-control" name="title" value="{{ $rows->title }}" placeholder="Tiêu đề ngôn ngữ" required>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="form-control">
                <label>
                  <input type="radio" name="status" value="1" {{ $rows->status == '1' ? 'checked' : '' }}>
                  <small>@lang('active')</small>
                </label>
                <label>
                  <input type="radio" name="status" value="2" class="ml-15"
                    {{ $rows->status == '2' ? 'checked' : '' }}>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="form-control">
                <label>
                  <input type="radio" name="is_default" value="1" {{ $rows->is_default == '1' ? 'checked' : '' }}>
                  <small>@lang('Có')</small>
                </label>
                <label>
                  <input type="radio" name="is_default" value="2" class="ml-15" {{ $rows->is_default == '2' ? 'checked' : '' }}>
			...
			<div class="form-group">
			  ...
			  <div class="input-group">
				...
				<input id="image" class="form-control" type="text" name="image" value="{{ $rows->image }}"
				  placeholder="@lang('image_link')...">
			  </div>
			  <div id="image-holder" style="margin-top:15px;max-height:100px;">
				@if ($rows->image != '')
				<img id="view_avatar" style="height: 5rem;" src="{{ $rows->image }}">
				@else
