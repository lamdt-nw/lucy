                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea name="brief[{{ $lang_tab->lang_code }}]" class="form-control" rows="5">{{ old('brief') }}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <div class="form-group">
                          ...
                          <textarea name="content[{{ $lang_tab->lang_code }}]" class="form-control" id="content_{{ $lang_tab->lang_code }}">{{ old('content') }}</textarea>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
